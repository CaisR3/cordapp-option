...
val COMPANY_STOCK_1 = Stock("IBM", DUMMY_OPTION_DATE)
val COMPANY_STOCK_2 = Stock("R3", DUMMY_OPTION_DATE)
...
val KNOWN_SPOTS = listOf(
        SpotPrice(COMPANY_STOCK_1, COMPANY_AMOUNT_1),
        SpotPrice(COMPANY_STOCK_2, COMPANY_AMOUNT_2)
)
val KNOWN_VOLATILITIES = listOf(
        Volatility(COMPANY_STOCK_1, COMPANY_VOLATILITY_1),
        Volatility(COMPANY_STOCK_2, COMPANY_VOLATILITY_2)
)